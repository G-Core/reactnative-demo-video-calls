      ...
      <View style={styles.container}>
        <View>   
            ...
            <View style={styles.toolbar}>
              ...
              <Pressable style={[styles.btn, videoOn ? styles.on : styles.off]} onPress={toggleVideo}>                  
                <CameraIcon/>  
              </Pressable>              
              <Pressable style={[styles.btn, audioOn ? styles.on : styles.off]} onPress={toggleAudio}>
                 <MicrophoneIcon/>
              </Pressable>
