...
import { NativeModules, Pressable, StyleSheet, Switch, Text, TextInput, View } from "react-native";
...
export const HomeScreen = ({ navigation }: NativeStackScreenProps<RootStackParamList, 'Home'>) => {
    ...
    const [clientHostName, onChangeClientHostName] = useState("https://meet.gcorelabs.com");
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.formgroup}>
          <Text style={[styles.label, styles.labelText, styles.labelPostion]}>Hostname</Text>
          <TextInput
        ...
        <View style={styles.formgroup}>
          <Text style={[styles.label, styles.labelText, styles.labelPostion]}>Room</Text>
          <TextInput
        ...
        <View style={styles.formgroup}>
          <Text style={[styles.label, styles.labelText, styles.labelPostion]}>Display name</Text>
          <TextInput
